...
function CtaA() {
  return (
    <section className="bg-white pb-24">
      <Container>
        <div className={`industry-cta-panel rounded-[2.5rem] bg-gradient-to-r from-slate-800 to-slate-300 p-10 text-white shadow-glow md:p-16 ${siteBranding.heroPanelClassName}`}>
          <SectionHeading
...
function CtaB() {
  return (
    <section className="bg-panel py-24">
      <Container className={`industry-cta-panel grid gap-8 rounded-[2.5rem] border border-line bg-shell px-10 py-14 text-white shadow-glow lg:grid-cols-[0.7fr_0.3fr] lg:items-center lg:px-12 ${siteBranding.heroPanelClassName}`}>
        <div>
...
function CtaC() {
  return (
    <section className="bg-panel py-24">
      <Container>
        <div className="industry-cta-panel grid gap-8 rounded-[2.5rem] border border-line bg-white p-10 shadow-soft lg:grid-cols-[0.55fr_0.45fr] lg:items-center lg:p-12">
          <div>
            <p className="industry-eyebrow text-sm uppercase tracking-[0.35em] text-accent">{siteConfig.cta.eyebrow}</p>
          ...
          <div className={`rounded-[2rem] bg-shell p-8 text-white shadow-glow ${siteBranding.heroPanelClassName}`}>
