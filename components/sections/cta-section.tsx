...
function CtaA() {
  return (
    <section className="bg-white pb-24">
      <Container>
        <div className={`industry-cta-panel premium-cta rounded-[2.5rem] bg-gradient-to-r from-slate-800 to-slate-300 p-[calc(var(--industry-card-padding)+0.15rem)] text-white shadow-glow md:p-[calc(var(--industry-card-padding)+1.5rem)] ${siteBranding.heroPanelClassName}`}>
          <SectionHeading
...
function CtaB() {
  return (
    <section className="bg-panel py-24">
      <Container className={`industry-cta-panel premium-cta grid gap-8 rounded-[2.5rem] border border-line bg-shell px-[calc(var(--industry-card-padding)+0.15rem)] py-[calc(var(--industry-card-padding)+1.1rem)] text-white shadow-glow lg:grid-cols-[0.7fr_0.3fr] lg:items-center lg:px-[calc(var(--industry-card-padding)+0.9rem)] ${siteBranding.heroPanelClassName}`}>
        <div>
...
function CtaC() {
  return (
    <section className="bg-panel py-24">
      <Container>
        <div className="industry-cta-panel premium-cta grid gap-8 rounded-[2.5rem] border border-line bg-white p-[calc(var(--industry-card-padding)+0.15rem)] shadow-soft lg:grid-cols-[0.55fr_0.45fr] lg:items-center lg:p-[calc(var(--industry-card-padding)+0.9rem)]">
          <div>
            <p className="industry-eyebrow text-sm uppercase tracking-[0.35em] text-accent">{siteConfig.cta.eyebrow}</p>
          ...
          <div className={`rounded-[2rem] bg-shell p-[var(--industry-card-padding)] text-white shadow-glow ${siteBranding.heroPanelClassName}`}>
